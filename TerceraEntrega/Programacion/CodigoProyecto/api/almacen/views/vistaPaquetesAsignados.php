...
<header>
  ...
  <div class="header-line"></div>
    ...
    <?php
        ...
        if (isset($_GET['lote_id'])) {
            ...
            echo "<td>{$paquete['fechaIngreso']}</td>";
                    echo "<td><button onclick=\"eliminarPaqueteDelLote({$paquete['codigoPaquete']})\">Eliminar del Lote</button></td>";
                    echo "</tr>";
                }
            }
        } else {
    ...
    <div id="btnVolver">
        <a href="vistaListaLotes.php"><button id="btnVolver">Volver</button></a>
    </div>
