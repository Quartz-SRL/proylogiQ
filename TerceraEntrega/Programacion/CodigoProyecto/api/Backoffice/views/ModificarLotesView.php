...
<div id="modificarDiv">
    <h2>Modificar Paquete</h2>
        ...
        if(isset($_GET['idLote_modificar'])){
            ...
            <form id="modificarLotesForm" action='../views/LotesView.php'>
                ...
                <label for="categoria">id almacen</label>
                <input class="inputs" type=text name="destino" value="<?php echo $lote['idAlmacen']; ?>">
                ...
                <input type="submit" value="modificarLote" id="btnAlta" onclick="modLote()">
            </form>
